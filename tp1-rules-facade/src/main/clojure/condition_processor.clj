...
(defn current? [value] (= (symbol (str (nth value 0)))  'current))
(defn past? [value] (= (symbol (str (nth value 0))) 'past))
(defn counter-value? [value] (= (symbol (str (nth value 0))) 'counter-value))
